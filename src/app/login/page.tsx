    ...
    <main className="relative min-h-screen flex flex-col items-center justify-center bg-background px-4">
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        <div className="relative valora-glass rounded-2xl p-8 border border-white/[0.06]
                        shadow-[0_40px_80px_rgba(0,0,0,0.5),0_0_60px_rgba(124,58,237,0.1)]">
          {/* Top accent line */}
          ...
          {error && (
            <div className="mb-5 p-3 bg-error/10 border border-error/20 rounded-xl text-xs text-error">
              <strong>Error:</strong> {error === "OAuthSignin" ? "Sign-in failed. Try again." : "Access denied."}
            </div>
          )}
          ...
          <div className="space-y-3">
            ...
            >
              <button
                type="submit"
                className="w-full py-3.5 px-5 bg-white hover:bg-zinc-50 text-zinc-900 rounded-xl
                           font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5
                           flex items-center gap-3 shadow-lg shadow-black/20 cursor-pointer group"
              >
                <GoogleIcon />
